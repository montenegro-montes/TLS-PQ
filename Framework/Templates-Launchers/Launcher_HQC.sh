...
if [[ "$AUTH_MODE" == "mutual" ]]; then
 ...
 SIG_L3=("secp384r1")
 SIG_L5=("secp521r1")
 KEMS_L1=("P-256" "x25519" "p256_mlkem512" "x25519_mlkem512" "mlkem512" "p256_hqc128" "x25519_hqc128" "hqc128")
 KEMS_L3=("P-384" "x448" "p384_mlkem768" "x448_mlkem768" "mlkem768" "p384_hqc192" "x448_hqc192" "hqc192")
