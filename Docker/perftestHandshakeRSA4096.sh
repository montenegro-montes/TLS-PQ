...
openssl genpkey -algorithm rsa-pss  -pkeyopt rsa_keygen_bits:4096 -pkeyopt rsa_pss_keygen_mgf1_md:sha384 -pkeyopt rsa_pss_keygen_md:sha384 -pkeyopt rsa_pss_keygen_saltlen:32   -out /opt/test/CA.key
...
openssl genpkey -algorithm rsa-pss  -pkeyopt rsa_keygen_bits:4096  -pkeyopt rsa_pss_keygen_mgf1_md:sha384 -pkeyopt rsa_pss_keygen_md:sha384   -pkeyopt rsa_pss_keygen_saltlen:32   -out /opt/test/server.key
