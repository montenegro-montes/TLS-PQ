...
parser = argparse.ArgumentParser(description="Procesar un archivo CSV y crear otro con las columnas 'Connections/User Sec' ordenadas por KEM.")
parser.add_argument('input_file', help='Nombre del archivo CSV de entrada')
parser.add_argument('output_file', nargs='?', help='Nombre del archivo CSV de salida (opcional)')
...
# Reemplazar 'secp384r1' por 'ecdsa-secp384r1' en las cabeceras
header_row = header_row.replace('secp384r1', 'ecdsa-secp384')
header_row = header_row.replace('secp521r1', 'ecdsa-secp521')
...
print(f"Nuevo CSV creado: '{args.output_file}'")